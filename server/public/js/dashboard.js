    ...
    .map((report) => {
      ...
      return {
        ...
        remediation_block: report.remediationBlock || {
          ...
          retestSuggestion: "Restart the current Kokuli web server and rerun the affected suite.",
        },
...
function buildLegacyAssessment(summaryData, latestData) {
  ...
  return {
    ...
    riskSummary: {
      ...
      recommendedFirstFix: findings[0] ? findings[0].remediation_summary : "Restart the current Kokuli server to restore the richer assessment endpoint.",
    },
    operatorSummary: {
